...
const TopHeader = () => {
    ...
    return (
        <>
            ...
            {/* ── Desktop header — full-width bar; sidebar sits underneath ── */}
            <header className="sticky top-0 z-40 hidden h-16 shrink-0 items-center bg-[#0f6e56] dark:bg-slate-900 md:flex">
                {/* Logo column = sidebar width so chrome reads as one continuous frame */}
