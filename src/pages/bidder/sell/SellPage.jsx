...
const SellPage = () => {
    ...
    const canSubmit = productName.trim() && description.trim() && price && unit && location.trim() && category

    return (
        <div className="bg-gradient-to-br from-[#f0fdf4] via-gray-50 to-gray-100 flex items-start justify-center px-4 py-10">
            <div className="w-full max-w-lg">
                ...
                <div className="mb-6">
                    <div className="inline-flex items-center gap-2 rounded-full bg-[#0EA432]/10 px-3 py-1 mb-3">
                        ...
                        <span className="text-xs font-semibold text-[#0EA432] uppercase tracking-wide">New Listing</span>
                    </div>
                    <h1 className="text-2xl font-bold text-gray-900 leading-tight">Post a Listing</h1>
                    <p className="mt-1 text-sm text-gray-500">
                        List your product or service — buyers will send you inquiries and quote requests.
                    </p>
                </div>
                    ...
                    <div className="px-5 py-5 space-y-4">
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                placeholder="e.g. Portland Cement OPC 42.5, Mesh Office Chairs..."
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Brand, grade, condition, quantity available, delivery options..."
                                rows={4}
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label className="flex items-center gap-1.5 text-sm font-medium text-gray-700 mb-1.5">
                                    ...
                                    Asking Price (MWK) <span className="text-red-500">*</span>
                                </label>
                                <Input
                                    type="text"
                                    inputMode="numeric"
                                ...
                                <div className="mt-1 h-5">
                                    <p className="text-green-700 text-sm min-h-4">
                                        MWK {price ? Number(price).toLocaleString() : ""}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div>
                                <label className="flex items-center gap-1.5 text-sm font-medium text-gray-700 mb-1.5">
                                    <Tag className="h-3.5 w-3.5 text-[#0EA432]" />
