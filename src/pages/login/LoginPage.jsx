    ...
    return (
        <div className="min-h-screen lg:grid lg:grid-cols-[70%_30%]">
            <section className="relative min-h-screen overflow-hidden bg-white">
                <BoxGradient>
                    <div className="relative z-10 flex min-h-screen items-center justify-center bg-white/50 px-3 py-6 md:px-6 md:py-8 mx-auto w-full max-w-4xl p-2">
                        <div className="grid min-h-[640px] grid-cols-1 gap-2 rounded-[1.3rem] p-2 lg:grid-cols-2">
                            <section className="flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-5 py-8 md:px-8">
                                <div className="w-full max-w-md">
                                    <div className="mb-8 flex justify-center flex-col items-center gap-2 text-sm font-semibold text-teal-700">

                                        <img src="/logo.png" alt="BidHub" className="h-25 w-25" />
                                        <span>BidHub</span>
                                    </div>
